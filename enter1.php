    ...
    <div class="container">
        ...
        <div class="form-container">
            ...
            <div class="input-group">
                ...
                <input type="password" id="password" class="input-field" placeholder="Введите ваш пароль">
            </div>
            
            <button class="button main-button" onclick="submitLogin()">Войти</button>
        </div>
